<template>
    ...
    <section id="noticias-info" class="noticias-section">
        <article class="noticias-info">
            <img class="centrado" src="../assets/u.jpeg" alt="">
            <h2 class="noticias-info__title">Como reciclar</h2>
            
            <p class="noticias-info">El reciclaje del plástico procedente de botellas PET sin los pasos químicos intermedios necesarios hasta ahora permitirá reemplazar el poliéster convencional de las carcasas de los neumáticos por uno más sostenible a partir de 2022, ha informado este jueves en un comunicado la empresa de neumáticos Continental.
